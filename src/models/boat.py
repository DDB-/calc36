from models.base_units import BoatClass

class TorpedoBoatDestroyer(BoatClass):
    def __init__(self):
        super().__init__(attack=2, defense=2, name="Torpedo Boat Destroyer", cost=0, movement=2)

class Destroyer(BoatClass):
    def __init__(self):
        super().__init__(attack=4, defense=4, name="Destroyer", cost=7, movement=3)

class CoastalDefenseShip(BoatClass):
    def __init__(self):
        # Cost is fake, is an approximation of what they provide
        super().__init__(attack=4, defense=6, name="Coastal Defense Ship", cost=0)
        self.bombard = 2

class LightCruiser(BoatClass):
    def __init__(self):
        super().__init__(attack=5, defense=5, name="Light Cruiser", cost=9, movement=3)
...
class HeavyCruiser(BoatClass):
    def __init__(self):
        super().__init__(attack=6, defense=6, name="Heavy Cruiser", cost=[5,5], movement=3)
        self.bombard = 2

class Battlecruiser(BoatClass):
    def __init__(self):
        super().__init__(attack=7, defense=7, name="Battlecruiser", cost=[7,7], movement=3)
        self.bombard = 3

# Health can be set in case we want to initialize a damaged Battleship
class Battleship(BoatClass):
    def __init__(self, health=2):
        super().__init__(attack=8, defense=8, name="Battleship", cost=[6,6,6], movement=2)
        self.bombard = 4
...
class HeavyBattleship(BoatClass):
    def __init__(self, health=3):
        super().__init__(attack=10, defense=10, name="Heavy Battleship", cost=[7,7,7], movement=3)
        self.bombard = 4
...
class LightCarrier(BoatClass):
    def __init__(self):
        super().__init__(attack=0, defense=1, name="Light Carrier", cost=[4,4], movement=3)

class FleetCarrier(BoatClass):
    def __init__(self, health=2):
        super().__init__(attack=0, defense=2, name="Fleet Carrier", cost=[5,5,5], movement=3)
        self.health = max(min(health, 2), 1) # Ensure health is between 1-2
...
class HeavyFleetCarrier(BoatClass):
    def __init__(self, health=2):
        super().__init__(attack=0, defense=2, name="Heavy Fleet Carrier", cost=[6,6,6], movement=3)
        self.health = max(min(health, 2), 1) # Ensure health is between 1-2
...
class CoastalSubmarine(BoatClass):
    def __init__(self):
        super().__init__(attack=2, defense=2, name="Coastal Submarine", cost=0, movement=1)
...
class Submarine(BoatClass):
    def __init__(self):
        super().__init__(attack=3, defense=3, name="Submarine", cost=6, movement=3)
...
class AdvancedSubmarine(BoatClass):
    def __init__(self):
        super().__init__(attack=4, defense=4, name="Advanced Submarine", cost=7, movement=3)
...
class NavalTransport(BoatClass):
    def __init__(self):
        super().__init__(attack=0, defense=0, name="Naval Transport", cost=7, movement=2)

class AttackTransport(BoatClass):
    def __init__(self):
        super().__init__(attack=0, defense=1, name="Attack Transport", cost=7, movement=2)
